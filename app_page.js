...
/**
 * Gets the configured sources from local storage.
 * @returns {string[]} The configured sources.
 */
...
/**
 * Filters a list of app versions to only include versions of a specific app.
 * @param {object[]} list - The list of app versions.
 * @param {object} app - The app to filter by.
 * @returns {object[]} The filtered list of app versions.
 */
...
async function start() {
    ...
    try {
        ...
        /**
         * Updates the UI for the selected version.
         */
